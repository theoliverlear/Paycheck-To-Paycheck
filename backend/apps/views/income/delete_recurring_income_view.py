...
class DeleteRecurringIncomeView(APIView):
    @inject
    def __init__(self,
                 auth_service: AuthService,
                 session_service: SessionService,
                 recurring_income_service: RecurringIncomeService,
                 recurring_income_dict_parser: RecurringIncomeDictParser):
        super().__init__()
        ...
        self.recurring_income_dict_parser: RecurringIncomeDictParser = \
            recurring_income_dict_parser
    ...
    async def async_delete(self, http_request, income_id: int, *args, **kwargs):
        ...
        if user_in_session:
            ...
            await self.recurring_income_service.delete_from_user(user, income_id)
    ...
    def delete(self, request, income_id: int, *args, **kwargs):
        return async_to_sync(self.async_delete)(request, income_id, *args, **kwargs)
